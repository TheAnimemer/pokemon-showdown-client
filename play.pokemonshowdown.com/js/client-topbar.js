(function ($) {
	...
	var CustomBackgroundPopup = this.CustomBackgroundPopup = Popup.extend({
		...
		initialize: function () {
			...
			buf += '<button name="setBg" value="tanoso" class="option' + (cur === 'tanoso' ? ' cur' : '') + '"><span class="bg" style="background-position:0 -' + (90 * 0) + 'px"></span>Tanoso</button>';
		...
		setBg: function (bgid) {
			...
			var bgUrl = (bgid === 'solidblue'
				? '#344b6c'
				: Dex.resourcePrefix + 'fx/client-bg-' + bgid + '.jpg');
